...
const OptionFD: React.FC<OptionFDProps> = ({ options, name, value, onChange }) => {
  return (
    <div>
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        >
          {options.map((option, index) => (
            <option key={index} value={option} className="text-body">
              {option}
            </option>
          ))}
        </select>
