...
import Image from '../../images/icon/House.svg';
                    ...
                    {/* <div className="hidden w-full xl:block xl:w-1/2">
                      <div className="py-17.5 px-26 text-center">
                        ...
                        <p className="2xl:px-20">
                          Welcome to our Real Estate Management System! Our
                          platform is designed to streamline all your property
                          management needs, whether you're a property owner,
                          tenant, or manager. Easily manage your property
                          listings, track maintenance requests, handle rental
                          payments, and communicate with tenants and service
                          providers all in one place. We are committed to
                          providing you with a seamless and efficient
                          experience, helping you stay organized and keep your
