        ...
        <div className="container mx-auto px-4">
          <div className="md:flex">
            <div className="flex -mb-px mr-8">
              <a
                href="#"
                className="no-underline text-black dark:text-white md:text-blue-dark flex items-center py-4 border-b border-blue-dark"
              >
                <svg
            ...
            <div className="flex -mb-px mr-8">
              <a
                href="#"
                className="no-underline text-black dark:text-white opacity-50 md:text-grey-dark md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-grey-dark"
              >
                <svg
                  className="h-6 w-6 fill-current mr-2"
                  xmlns="http://www.w3.org/2000/svg"
